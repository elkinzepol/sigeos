...
<div class="container-fluid">
    <form class="dashboard-container FormularioAjax" method="POST" data-form="save" data-lang="<?php echo LANG; ?>" autocomplete="off" action="<?php echo SERVERURL;?>ajax/clienteAjax.php" >
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,35}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="form-control" oninput="actualizarValorContrasena()" name="cliente_id_reg" id="cliente_id" maxlength="10">
                            <label for="cliente_id" class="form-label"> C.C. <?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-outline mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-outline mb-4">
                            <input type="tel" pattern="[0-9()+]{8,20}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="form-control" name="cliente_telefono_reg" id="cliente_telefono" maxlength="10">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <legend><i class="fas fa-users"></i> &nbsp;Tipo</legend>
                        <div class="mb-4">
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="cliente_genero_reg" value="Persona" id="cliente_genero_male" checked />
                                <label class="form-check-label" for="cliente_genero_male">Persona</label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="cliente_genero_reg" value="Empresa" id="cliente_genero_female" />
                                <label class="form-check-label" for="cliente_genero_female">Empresa</label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <fieldset class="mb-4">
            <legend><i class="fas fa-map-marked-alt"></i> &nbsp; Información de Domicilio</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,29}" class="form-control" name="cliente_provincia_reg" placeholder="Cesar" value="Cesar" id="cliente_provincia" maxlength="10">
                            <label for="cliente_provincia" class="form-label">Departamento <?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,29}" class="form-control" name="cliente_ciudad_reg" placeholder="Valledupar" value="Valledupar" id="cliente_ciudad" maxlength="29">
        ...
        <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    function actualizarValorContrasena() {
                        let pass = document.getElementById("cliente_id").value;
                        document.getElementById("cliente_clave_1").value = pass;
                        document.getElementById("cliente_clave_2").value = pass;
                    }
                    </script>

                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-outline mb-4">
                            <input type="password" class="form-control" value=" " name="cliente_clave_1_reg" id="cliente_clave_1" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" >
                            <label for="cliente_clave_1" class="form-label">Contraseña <?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-outline mb-4">
                            <input type="password" class="form-control" value=" " name="cliente_clave_2_reg" id="cliente_clave_2" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" >
