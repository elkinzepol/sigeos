    ...
    <div class="full-box nav-lateral-content scroll">
        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <li>
                <a href="javascript:void(0);" class="nav-btn-submenu"><i class="fas fa-tags"></i> &nbsp; Tienda Online <i class="fas fa-chevron-down"></i></a>
                    <ul>
                ...
                <li>
                <a href="javascript:void(0);" class="nav-btn-submenu"><i class="fas fa-briefcase"></i> &nbsp; Soporte tecnico <i class="fas fa-chevron-down"></i></a>
                    <ul>
                        <?php if($_SESSION['cargo_sto']=="Administrador"){ ?>
                        <li>
                            <a href="javascript:void(0);" class="nav-btn-submenu"><i class="fas fa-tag fa-fw"></i> &nbsp; Marcas <i class="fas fa-chevron-down"></i></a>
                            <ul>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/category-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; Nueva Marca</a>
                                </li>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/category-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de Marcas</a>
                                </li>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/category-search/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar Marca</a>
                                </li>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="nav-btn-submenu"><i class="fas fa-tools fa-fw"></i> &nbsp; Ordenes de Servicios <i class="fas fa-chevron-down"></i></a>
                            <ul>
                                <?php if($_SESSION['cargo_sto']=="Administrador"){ ?>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/product-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; Crear Orden de Servicio</a>
                                </li>
                                <?php } ?>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/product-list/"><i class="fas fa-boxes fa-fw"></i> &nbsp; Ordenes de Servicios</a>
                                </li>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/product-minimum/"><i class="fas fa-tasks fa-fw"></i> &nbsp; OS Pendientes</a>
                                </li>
                                <li>
                                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/product-search/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar Ordenes de Servicio</a>
                                </li>
                            </ul>
                        </li>
