<?php
	...
	----------*/
	const SESSION_NAME="Administrado";


	/*----------  Redes sociales - Social networks  ----------*/
	const FACEBOOK="https://www.facebook.com/intelcovalledupar";
	const INSTAGRAM="https://www.instagram.com/tiendaintelco";
	const YOUTUBE="";
	const TWITTER="";


	/*----------  Direccion - Address  ----------*/
	const COUNTRY="Valledupar";
	const ADDRESS="Valledupar, Colombia, America Del sur";
